...
const Navbar = ({ clicked, setClicked }) => {
  ...
  useEffect(() => {
    ...
    function revealMenuItems() {
      ...
      tl
        .to(".overlay svg path", { duration: 0, visibility: "visible" })
        .to("#hamburger", {
          duration: 1.25,
          marginTop: "-5px",
          x: -40,
        ...
        .to("#hamburger span", { duration: 1, background: "#F4FF00", ease: "power2" }, "<")
        .to(spanBefore, { duration: 1, ease: "power2", background: "#F4FF00"  }, "<")
        .to(path, { duration: 0.8, attr: { d: start }, ease: "power2.in" }, "<")
        .to(path, { duration: 0.8, attr: { d: end }, ease: "power1.out" }, "-=0.5")
  ...
  return (
    ...
    {isFixed ? (
      <div className='bg-[#1e1e1e] w-[100vw] h-[8rem]'></div>
    ) : ""}
    <a href="/"><Image src={Logo} alt='Logo' className='logo absolute top-0 left-0 w-[100px] p-4 m-[2em] mt-[3rem] z-[2]'></Image></a>
        ...
        <div className="primary-menu">
            <div className="menu-container">
                <div className="wrapper">
                    ...
                    <div className="menu-item">
                        <a href="/ourservices"><span>II</span>Our Work</a>
                        <div className="menu-item-revealer"></div>
                    </div>
                    <div className="menu-item">
                        <a href="/shop"><span>III</span>Shop</a>
                        <div className="menu-item-revealer"></div>
                    </div>
                </div>
            </div>
